...
import { addProductsAsync, decreaseQuantityAsync, removeItemAsync, toggleFavoriteAsync } from '../../redux/actions/action';
            ...
            <div className="col">
                <div className={s.cartItem__logic}>
                    <div className={s.cartItem__first}>
                        ...
                        <p><span>Total:</span>{item.total}som</p>
                    </div>
                    <div

                        className={s.cartItem__second}>
                        <RemoveIcon
